...
function EventCard() {
  return (
    <div>
      ...
      <div className="flex justify-start items-center gap-5 p-3 bg-brightGray">
        <div className="w-20 h-20 rounded-full bg-indianRed text-white font-bold flex flex-col flex-shrink-0 justify-center items-center">
          <p className="text-2xl">24</p>
          <p className="text-lg -mt-2.5 uppercase">May</p>
        </div>
        <div className="">
          ...
          <div className="flex justify-start items-center gap-1">
            ...
            <span className="text-lg font-normal text-venetianRed">
              5:00 PM - 8:00 PM
            </span>
          </div>
          <div className="flex justify-start items-center gap-1">
            ...
            <span className="text-lg font-normal text-venetianRed">Dhaka</span>
          </div>
        </div>
      </div>
      <Button path="/events/id" title="View Details" />
    </div>
  );
}
